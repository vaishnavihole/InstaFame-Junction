...
import {apiV1SendMessage, apiV1GetUserChat} from "./controllers/message/message.js";
...
app.get("/api/v1/getAccountsByUserId/:userId", apiV1GetAccountsByUserId);
...
app.get("/api/v1/userChat", apiV1GetUserChat);
